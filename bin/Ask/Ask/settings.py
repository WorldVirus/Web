...
SECRET_KEY = '7%(2=ekd2&hm(w3-*608!4=7zc+2dnf6_$tqkb^*hst#^wn=s*'
...
# Application definition ADD WAY IN DIR FOR 4 POINT
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/Users/user/AskVeniamin/bin/Ask/questions/templates'],
